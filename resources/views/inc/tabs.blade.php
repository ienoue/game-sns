...
<nav class="nav nav-pills nav-fill flex-column flex-lg-row mb-4">
    ...
    <a @class([
        ...
        'active' => $postsPage,
    ]) href="{{ route('users.index', ['user' => $user->name]) }}">
    ...
    <a @class([
        ...
        'active' => $likesPage,
    ]) href="{{ route('users.likes', ['user' => $user->name]) }}">
    ...
    <a @class([
        ...
        'active' => $commentsPage,
    ]) href="{{ route('users.comments', ['user' => $user->name]) }}">
    ...
    <a @class([
        ...
        'active' => $battlesPage,
    ]) href="{{ route('users.battles', ['user' => $user->name]) }}" tabindex="-1"
        aria-disabled="true">
    ...
    <a @class([
        ...
        'active' => $monstersPage,
    ]) href="{{ route('users.monsters', ['user' => $user->name]) }}" tabindex="-1"
        aria-disabled="true">
